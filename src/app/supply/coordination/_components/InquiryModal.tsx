    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-lg overflow-hidden rounded-2xl bg-white shadow-2xl">
        <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
          <div>
            <h3 className="text-base font-bold text-gray-900">Hỏi Bếp</h3>
            <p className="mt-0.5 text-xs text-gray-500">
              Gửi yêu cầu kiểm tra năng lực sản xuất bù trước khi ra quyết định
              phân bổ.
            </p>
          </div>
          <button
        ...
        <div className="space-y-4 p-5">
          <div className="rounded-xl bg-violet-50 p-4">
            <p className="text-[10px] font-bold uppercase tracking-wider text-violet-700/70">
              Sản phẩm
            </p>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-900">
              Nếu Bếp phản hồi “kịp/không kịp”, Điều phối viên sẽ chốt tỷ lệ
              phân bổ và duyệt hàng loạt.
            </div>
          </div>
          ...
          <div>
            ...
            <Textarea
              ...
              className="min-h-[96px] text-black rounded-xl border-2 border-gray-200 bg-white text-sm"
            />
          </div>
