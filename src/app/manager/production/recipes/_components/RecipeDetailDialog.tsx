              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-slate-50/80">
                    <TableHead className="text-xs text-slate-800">
                      Nguyên liệu
                    </TableHead>
                    <TableHead className="text-xs w-[100px] text-slate-800">
                      Định mức
                    </TableHead>
                    <TableHead className="text-xs w-[88px] text-slate-800">
                      ĐVT (NL)
                    </TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {d.bom.map((line) => (
                    <TableRow
                      key={`${line.ingredientProductId}-${line.ingredientName}`}
                    >
