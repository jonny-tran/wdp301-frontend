...
import { Pencil, Trash2, InboxIcon, Eye, UserPlus } from "lucide-react";
...
interface Props {
  ...
  onRegisterStaff: (store: Store) => void; // Chức năng mới
}
    ...
    <Table>
      <TableHeader>
        <TableRow className="bg-slate-50/80 hover:bg-slate-50/80">
          ...
          <TableHead className="text-right pr-6 text-xs font-semibold text-slate-500 w-[160px]">
            Thao tác
          </TableHead>
        </TableRow>
      </TableHeader>
            ...
            >
              ...
              <TableCell className="text-right pr-6">
                <div className="flex justify-end gap-1">
                  ...
                  {/* Nút Ghi danh nhân sự (POST staff) */}
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 text-slate-400 hover:text-emerald-600"
                    onClick={() => onRegisterStaff(store)}
                  >
                    <UserPlus className="h-4 w-4 stroke-[2.8px]" />
                  </Button>
                  ...
                  >
                    <Trash2 className="h-4 w-4 stroke-[2.8px]" />
                  </Button>
                </div>
              </TableCell>
            </TableRow>
