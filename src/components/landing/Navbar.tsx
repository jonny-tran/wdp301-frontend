...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed w-full z-50 top-0 start-0 transition-all duration-300 py-4 px-6 md:px-12 flex justify-between items-center ${isScrolled ? "bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm" : "bg-transparent border-transparent"}`}
    >
      {/* Logo Section - Left */}
      ...
      >
        <ul className="font-bold flex p-4 md:p-0 border border-gray-100 rounded-lg md:flex-row md:space-x-10 md:mt-0 md:border-0 uppercase text-sm tracking-wider">
          <li>
            <Link
              href="#"
              className="block py-2 px-3 text-primary transition-colors"
              aria-current="page"
            >
              Home
            </Link>
          ...
          <li>
            <Link
              href="#"
              className="block py-2 px-3 text-text-muted hover:text-primary transition-colors"
            >
              About
            </Link>
          </li>
      ...
      <div className="flex items-center space-x-6 flex-shrink-0">
        <span className="hidden xl:inline-block text-xs font-bold text-text-muted uppercase tracking-[0.2em]">
          Support 24/7
        </span>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden sm:block text-left">
                <p className="text-[10px] font-black text-text-main uppercase leading-none">
                  {user.username}
                </p>
                <p className="text-[8px] font-bold text-text-muted uppercase tracking-wider mt-0.5">
